...
public class LoveLayout extends RelativeLayout{
    ...
    private void initDrawable() {
        mRed = getResources().getDrawable(R.mipmap.pl_red);
        mYellow = getResources().getDrawable(R.mipmap.pl_yellow);
        mBlue = getResources().getDrawable(R.mipmap.pl_blue);
    ...
    public void addLove() {
        ...
        finalSet.setInterpolator(mInterpolators[mRandom.nextInt(mInterpolators.length)]);
...
// 2.缩放动画
        ...
        bezierSet.playSequentially(animatorSet, bezierValueAnimator);
